...
GSList*
iog_pixbuf_get_savable_formats (void)
{
	GSList *list;
...
GdkPixbufFormat*
iog_pixbuf_get_format_by_suffix (const char *suffix)
{
	GSList *list;
	GSList *it;
...
char*
iog_pixbuf_get_common_suffix (GdkPixbufFormat *format)
{
	char **extensions;
	int i;
	char *result = NULL;
...
GdkPixbufFormat *
iog_pixbuf_get_format (GFile *file)
{
	GdkPixbufFormat *format;
	...
	format = iog_pixbuf_get_format_by_suffix (suffix);
