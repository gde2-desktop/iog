...
/**
 * iog_image_load_error_message_area_new:
 * @caption:
 * @error:
 *
 *
 ...
 **/
GtkWidget *
iog_image_load_error_message_area_new (const gchar  *caption,
				       const GError *error)
{
	GtkWidget *message_area;
	...
	message_details = iog_util_make_valid_utf8 (error->message);
...
/**
 * iog_no_images_error_message_area_new:
 * @file:
 *
 *
 *
 ...
 **/
GtkWidget *
iog_no_images_error_message_area_new (GFile *file)
{
	GtkWidget *message_area;
	gchar *error_message = NULL;
