...
typedef ExifData IogExifData;

/* Define IogExifData type */
G_DEFINE_BOXED_TYPE(IogExifData, iog_exif_data, iog_exif_data_copy, iog_exif_data_free)
...
#ifdef HAVE_STRPTIME
static gchar *
iog_exif_util_format_date_with_strptime (const gchar *date)
{
...
#else
static gchar *
iog_exif_util_format_date_by_hand (const gchar *date)
{
 ...
 */
gchar *
iog_exif_util_format_date (const gchar *date)
{
	gchar *new_date;
#ifdef HAVE_STRPTIME
	new_date = iog_exif_util_format_date_with_strptime (date);
#else
	new_date = iog_exif_util_format_date_by_hand (date);
#endif /* HAVE_STRPTIME */
	return new_date;
}

/**
 * iog_exif_data_get_value:
 ...
 */
const gchar *
iog_exif_data_get_value (IogExifData *exif_data, gint tag_id, gchar *buffer, guint buf_size)
{
...
IogExifData *
iog_exif_data_copy (IogExifData *data)
{
	exif_data_ref (data);
...
void
iog_exif_data_free (IogExifData *data)
{
